...
<div class="panel panel-info">
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td><{$smarty.const.MD_QUOTES_CATEGORY_ID}></td>
            <td><{$category.id}></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_QUOTES_CATEGORY_PID}></td>
            <td><{$category.pid}></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_QUOTES_CATEGORY_TITLE}></td>
            <td><{$category.title}></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_QUOTES_CATEGORY_DESCRIPTION}></td>
            <td><{$category.description}></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_QUOTES_CATEGORY_IMAGE}></td>
            <td><img src="<{$xoops_url}>/uploads/quotes/category/<{$category.image}>" alt="category" class="img-responsive"></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_QUOTES_CATEGORY_WEIGHT}></td>
            <td><{$category.weight}></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_QUOTES_CATEGORY_COLOR}></td>
            <td><span style="background-color: <{$category.color}>;">&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
        </tr>
        <tr>
            <td><{$smarty.const.MD_QUOTES_CATEGORY_ONLINE}></td>
