...
<div class="panel panel-info">
    ...
    <table class="table table-striped">
        <thead>
                <tr>
                    <th><{$smarty.const.MD_QUOTES_QUOTE_ID}></th>  <th><{$smarty.const.MD_QUOTES_QUOTE_CID}></th>  <th><{$smarty.const.MD_QUOTES_QUOTE_AUTHOR_ID}></th>  <th><{$smarty.const.MD_QUOTES_QUOTE_QUOTE}></th>  <th><{$smarty.const.MD_QUOTES_QUOTE_ONLINE}></th>  <th><{$smarty.const.MD_QUOTES_QUOTE_CREATED}></th>  <th><{$smarty.const.MD_QUOTES_QUOTE_UPDATED}></th><th  width="80"><{$smarty.const.MD_QUOTES_ACTION}></th>
            </tr>
            </thead>
