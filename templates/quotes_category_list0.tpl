...
<div class="panel panel-info">
    ...
    <table class="table table-striped">
        <thead>
        <tr>
            <th><{$smarty.const.MD_QUOTES_CATEGORY_ID}></th>
            <th><{$smarty.const.MD_QUOTES_CATEGORY_PID}></th>
            <th><{$smarty.const.MD_QUOTES_CATEGORY_TITLE}></th>
            <th><{$smarty.const.MD_QUOTES_CATEGORY_DESCRIPTION}></th>
            <th><{$smarty.const.MD_QUOTES_CATEGORY_IMAGE}></th>
            <th><{$smarty.const.MD_QUOTES_CATEGORY_WEIGHT}></th>
            <th><{$smarty.const.MD_QUOTES_CATEGORY_COLOR}></th>
            <th><{$smarty.const.MD_QUOTES_CATEGORY_ONLINE}></th>
