    ...
    <div class="outer">
         <form name="select" action="category.php?op=" method="POST"
          ...
          <table class="$category" cellpadding="0" cellspacing="0" width="100%">
            <tr><th align="center" width="5%"><input name="allbox" title="allbox" id="allbox" onclick="xoopsCheckAll('select', 'allbox');" type="checkbox" title="Check All"  value="Check All" ></th>  <th class="left"><{$selectorid}></th>  <th class="left"><{$selectorpid}></th>  <th class="left"><{$selectortitle}></th>  <th class="left"><{$selectordescription}></th>  <th class="left"><{$selectorimage}></th>  <th class="center"><{$selectorweight}></th>  <th class="center"><{$selectorcolor}></th>  <th class="center"><{$selectoronline}></th>
