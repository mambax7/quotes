    ...
    <div class="outer">
         <form name="select" action="quote.php?op=" method="POST"
          ...
          <table class="$quote" cellpadding="0" cellspacing="0" width="100%">
            <tr><th align="center" width="5%"><input name="allbox" title="allbox" id="allbox" onclick="xoopsCheckAll('select', 'allbox');" type="checkbox" title="Check All"  value="Check All" ></th>  <th class="left"><{$selectorid}></th>  <th class="left"><{$selectorcid}></th>  <th class="left"><{$selectorauthor_id}></th>  <th class="left"><{$selectorquote}></th>  <th class="left"><{$selectoronline}></th>  <th class="left"><{$selectorcreated}></th>  <th class="left"><{$selectorupdated}></th>
