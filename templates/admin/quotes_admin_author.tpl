    ...
    <div class="outer">
         <form name="select" action="author.php?op=" method="POST"
          ...
          <table class="$author" cellpadding="0" cellspacing="0" width="100%">
            <tr><th align="center" width="5%"><input name="allbox" title="allbox" id="allbox" onclick="xoopsCheckAll('select', 'allbox');" type="checkbox" title="Check All"  value="Check All" ></th>  <th class="left"><{$selectorid}></th>  <th class="left"><{$selectorname}></th>  <th class="center"><{$selectorcountry}></th>  <th class="left"><{$selectorbio}></th>  <th class="left"><{$selectorphoto}></th>  <th class="left"><{$selectorcreated}></th>  <th class="left"><{$selectorupdated}></th>
