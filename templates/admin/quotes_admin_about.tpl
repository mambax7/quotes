            ...
            <td class="aligntop width45">
                <fieldset>
                    ...
                    <div>
                        ...
                        <label><{$smarty.const.AM_QUOTES_ABOUT_DESCRIPTION}></label>
                        <text><{$module_description}></text>
                        <br>
                        <label><{$smarty.const.AM_QUOTES_ABOUT_AUTHOR}></label>
                        <text><{$module_author}></text>
                        <br>
                        <label><{$smarty.const.AM_QUOTES_ABOUT_CREDITS}></label>
                        <text><{$module_credits}></text>
                        <br>
                        <label><{$smarty.const.AM_QUOTES_ABOUT_LICENSE}></label>
                ...
                <fieldset>
                    ...
                    <div>
                        <label><{$smarty.const.AM_QUOTES_ABOUT_RELEASEDATE}></label>
                        <text class="bold"><{$module_update_date}></text>
                        <br>
                        <label><{$smarty.const.AM_QUOTES_ABOUT_MODULE_STATUS}></label>
                        <text><{$module_status}></text>
                        <br>
                        <label><{$smarty.const.AM_QUOTES_ABOUT_WEBSITE}></label>
                ...
                <fieldset>
                    ...
                    <div>
                        <label><{$smarty.const.AM_QUOTES_ABOUT_AUTHOR_NAME}></label>
                        <text><{$module_author}></text>
                        <br>
                        <label><{$smarty.const.AM_QUOTES_ABOUT_WEBSITE}></label>
