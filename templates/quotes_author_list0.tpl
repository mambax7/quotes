...
<div class="panel panel-info">
    ...
    <table class="table table-striped">
        <thead>
                <tr>
                    <th><{$smarty.const.MD_QUOTES_AUTHOR_ID}></th>  <th><{$smarty.const.MD_QUOTES_AUTHOR_NAME}></th>  <th><{$smarty.const.MD_QUOTES_AUTHOR_COUNTRY}></th>  <th><{$smarty.const.MD_QUOTES_AUTHOR_BIO}></th>  <th><{$smarty.const.MD_QUOTES_AUTHOR_PHOTO}></th>  <th><{$smarty.const.MD_QUOTES_AUTHOR_CREATED}></th>  <th><{$smarty.const.MD_QUOTES_AUTHOR_UPDATED}></th><th  width="80"><{$smarty.const.MD_QUOTES_ACTION}></th>
            </tr>
            </thead>
