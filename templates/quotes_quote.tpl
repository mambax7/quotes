    ...
    <table class="table table-striped">
        <thead>
            ...
            <tr>
                        ...
                        <td><{$smarty.const.MD_QUOTES_QUOTE_ID}></td>       <td><{$quote.id}></td>
             </tr>
        <tr>  <td><{$smarty.const.MD_QUOTES_QUOTE_CID}></td>       <td><{$quote.cid}></td>
             </tr>
        <tr>  <td><{$smarty.const.MD_QUOTES_QUOTE_AUTHOR_ID}></td>       <td><{$quote.author_id}></td>
             </tr>
        <tr>  <td><{$smarty.const.MD_QUOTES_QUOTE_QUOTE}></td>       <td><{$quote.quote}></td>
             </tr>
        <tr>  <td><{$smarty.const.MD_QUOTES_QUOTE_ONLINE}></td>       <td><{$quote.online}></td>
             </tr>
        <tr>  <td><{$smarty.const.MD_QUOTES_QUOTE_CREATED}></td>       <td><{$quote.created}></td>
             </tr>
        <tr>  <td><{$smarty.const.MD_QUOTES_QUOTE_UPDATED}></td>       <td><{$quote.updated}></td>
             </tr>
